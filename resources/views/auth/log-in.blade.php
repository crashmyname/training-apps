...
<head>
    ...
    <link href="{{ asset('log/style.css') }}" rel="stylesheet">
</head>
<body>
    <form>
...
<script src="{{asset('log/js.js')}}"></script>
<script src="https://unpkg.com/gsap@2.1.3/src/minified/TweenMax.min.js"></script>
<!-- Include MorphSVGPlugin -->
<script src="https://unpkg.com/morphsvgplugin@0.10.0/minified/MorphSVGPlugin.min.js"></script>
